...
public class BlockLogicFrameLever extends BlockLogicLever implements IBlockLogicFrame {
	public BlockLogicFrameLever(@NotNull Block<BlockLogicFrameLever> block) {
		super(block);
