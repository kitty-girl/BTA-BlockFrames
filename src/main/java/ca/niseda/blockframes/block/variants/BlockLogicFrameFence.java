...
public class BlockLogicFrameFence extends BlockLogicFence implements IBlockLogicFrame {
	public BlockLogicFrameFence(@NotNull Block<BlockLogicFrameFence> block) {
		super(block);
