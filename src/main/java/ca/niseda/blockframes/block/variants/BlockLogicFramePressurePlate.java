...
public class BlockLogicFramePressurePlate<T extends Entity>extends BlockLogicPressurePlate<T> implements IBlockLogicFrame {
	public BlockLogicFramePressurePlate(@NotNull Block<BlockLogicFramePressurePlate<T>> block, Class<T> mobClass) {
		super(block, mobClass, Materials.IRON);
