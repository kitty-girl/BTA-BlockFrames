...
public class BlockLogicFrameFenceGate extends BlockLogicFenceGate implements IBlockLogicFrame {
	public BlockLogicFrameFenceGate(@NotNull Block<BlockLogicFrameFenceGate> block) {
		super(block);
