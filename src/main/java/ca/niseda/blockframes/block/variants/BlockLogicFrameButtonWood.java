...
public class BlockLogicFrameButtonWood extends BlockLogicButtonPlanksOak implements IBlockLogicFrame {
	public BlockLogicFrameButtonWood(@NotNull Block<BlockLogicFrameButtonWood> block) {
		super(block);
